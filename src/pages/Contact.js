  ...
  return (
    <main className="container contact-container">
      ...
      <p className="contact-text">
        ...
        <strong> Address:</strong> MA LICHMA DEVI LIBRARY, Near aaryuvedic hospital, Ward No. 7, Jandawali, Hanumangarh(335512), Rajasthan
      </p>
      ...
      <p className="contact-text">
        ...
        <strong> Phone:</strong> +91 94134-30527
      </p>
